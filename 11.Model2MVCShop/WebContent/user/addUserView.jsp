...
<div class="navbar  navbar-default">
	...
	<div class="container">
		...
		<h3 class="bg-primary text-center"></h3>
		...
		<form class="form-horizontal">
		  ...
		  <div class="form-group">
		    <label for="ssn" class="col-sm-offset-1 col-sm-3 control-label">휴대폰 번호</label>
		     <div class="col-sm-2">
		  ...
		  <div class="form-group">
		    <div class="col-sm-offset-4  col-sm-4 text-center">
			  ...
			  <a class="btn btn-warning btn" href="#" role="button">재입력</a>
		    </div>
		  </div>
		</form>
		<!-- form Start /////////////////////////////////////-->
