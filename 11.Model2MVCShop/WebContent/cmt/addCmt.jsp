...
$(function() {
	...
	$( "button:contains('등록')").on("click" , function() {
		$("#cmt").attr("method" , "POST").attr("action" , "/board/addCmt").submit();
	});
		    ...
		    <div class="wrapper">
				    ...
				    <div class="three">
				    			<div class="row">
				    				...
				    				<div class="row">
				    					<div class="col-md-12"> 
				    								<p>작성자 : ${user.userId} <input type="hidden" name="userId" value="${user.userId }"></p>
										  			<p><input type="text" name="boardNo" value="${cmt.boardNo }"></p>
